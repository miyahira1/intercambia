      ...
      <div className="flex-1 flex gap-2 p-3">
        ...
        <div className="flex flex-col gap-2 w-72">
          ...
          <div className="bg-gray-800 rounded-2xl p-3">
            <div className="text-xs text-gray-400 mb-1.5">Idioma a intercambiar</div>
            <select
              value={selectedLang}
          ...
          <div className="bg-[#1E40AF] rounded-2xl p-4 text-center">
            <div className="text-xs text-blue-200 mb-1">{lang.first} · 1er segmento</div>
          ...
          <div className="flex-1 bg-white rounded-2xl flex flex-col min-h-0 overflow-hidden">
            <div className="flex-1 p-3 overflow-y-auto space-y-2 text-xs">
              ...
              <div className="flex gap-2">
                <span className="bg-gray-100 rounded-xl px-3 py-1.5 text-gray-700 max-w-[80%]">Muy bien. Empezamos en {lang.first.toLowerCase()} primero.</span>
              </div>
            </div>
