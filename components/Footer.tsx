      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        <div className="flex flex-col md:flex-row justify-between items-start gap-8">
          ...
          <div className="flex flex-wrap gap-6 text-sm text-gray-500">
            <Link href="/privacidad" className="hover:text-[#1E40AF] transition-colors">{t.footer.privacy}</Link>
            <Link href="/terminos" className="hover:text-[#1E40AF] transition-colors">{t.footer.terms}</Link>
            <Link href="/contacto" className="hover:text-[#1E40AF] transition-colors">{t.footer.contact}</Link>
          </div>
